...
class ItemClaimRequest(models.Model):
    ...
    def action_approve(self):
        for record in self:
            ...
            template_claimer = self.env.ref('lost_found_dashboard.email_template_v3_claim_approved', raise_if_not_found=False)
            if template_claimer:
            ...
            if record.found_item_id:
                ...
                template_finder = self.env.ref('lost_found_dashboard.email_template_v3_finder_matched', raise_if_not_found=False)
                ...
                template_loser = self.env.ref('lost_found_dashboard.email_template_v3_loser_matched', raise_if_not_found=False)
    ...
    def action_reject(self):
        for record in self:
            ...
            template = self.env.ref('lost_found_dashboard.email_template_v3_claim_rejected', raise_if_not_found=False)
            if template:
